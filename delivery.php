...
<div class="returns">
  <div class="container">
    ...
    <p>Доставим ваш заказ в любое из более чем 50 тыс. отделений Почты России или отправим курьером "до двери" по Москве и в любой другой город РФ.</p>
    <p>Комплектация заказа 1-3 рабочих дней. Доставка по Москве 1-2 дня, по России от 2-х дней.</p>
    <p>Отследить посылку после отправки можно на сайте pochta.ru/tracking</p>
    <p>Как только заказ придет в почтовое отделение, вам поступит смс-уведомление. Для получения посылки необходимо будет взять с собой паспорт. Если вы выбрали курьерскую доставку, с вами свяжется представитель курьерской службы для согласования места и времени доставки.</p>
    <p>Если после получения заказа что-либо не устроило, например, не подошел размер, вернуть/обменять товар можно в течение 14 дней.</p>
    <p>Бесплатное хранение посылки в почтовом отделении в течение 30 дней.</p>
    <p><b>Оплата</b></p>
    <p>Оплатить заказ можно при получении или банковской картой на нашем сайте онлайн. Мы принимаем к оплате карты Visa, Mastercard, МИР всех российских банков, а также Юmoney (ex. Яндекс.Деньги).</p>
